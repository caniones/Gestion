object dmArticulos: TdmArticulos
  ...
  object ibdsArticulos: TIBDataSet
    ...
    object ibdsArticulosCOSTO_UNITARIO: TIBBCDField
      ...
      Required = True
      OnChange = ibdsArticulosCOSTO_UNITARIOChange
      DisplayFormat = '$#,##0.00'
      EditFormat = '#,##0.00'
      Precision = 18
      Size = 4
    ...
    object ibdsArticulosUTILIDAD: TIBBCDField
      ...
      Required = True
      OnChange = ibdsArticulosUTILIDADChange
      DisplayFormat = '%0.00'
      EditFormat = '0.##'
      Precision = 18
      Size = 4
    ...
    object ibdsArticulosIVA: TIBBCDField
      ...
      Required = True
      OnChange = ibdsArticulosIVAChange
      DisplayFormat = '%0.00'
      EditFormat = '0.##'
      Precision = 18
      Size = 4
    ...
    object ibdsArticulosPRECIO_PUBLICO: TIBBCDField
      ...
      Required = True
      OnChange = ibdsArticulosPRECIO_PUBLICOChange
      DisplayFormat = '$#,##0.00'
      EditFormat = '#,##0.00'
      Precision = 18
      Size = 4
